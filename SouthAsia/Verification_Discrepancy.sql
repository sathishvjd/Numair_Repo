...
ROUND(SUM(VCM.COST)) AS TOTAL_VERIFICATION_COST,
ROUND(SUM(VCM.COST) /COUNT(DISTINCT VCM.USER_PROFILE_ID), 2) AS AVG_COSTS,
...
/*
 ...
 2. VERIFICATION COST DOES NOT MATCH WITH VERIFICATION_USER_COST TABLE 9.93 IN CE VS 4.36 IN VCM
 */
