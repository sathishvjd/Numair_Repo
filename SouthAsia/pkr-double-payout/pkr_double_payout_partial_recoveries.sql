...
LAST_VALUE(INVOICE_VALUE_LOCAL) OVER (PARTITION BY CTE.TRANSFER_ID ORDER BY LAST_UPDATED) AS SOURCE_AMOUNT,
...
SELECT
*
FROM PARTIAL_RECOVERIES ORDER BY USER_PROFILE_ID
